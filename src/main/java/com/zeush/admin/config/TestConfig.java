...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		 ...
		 */
		Empresa e1 = new Empresa(null, "22222222222", "Empresa11", "TstEmpresa11", "Rua 02 lote 02", "22222222",
				"Brasília", "DF", "Brasil", 10, "pessoa_fisica", "pessoa_fisica");
		Empresa e2 = new Empresa(null, "12222222222", "Empresa22", "TstEmpresa22", "Rua 01 lote 01", "11111111",
				"Brasília", "DF", "Brasil", 1, "pessoa_juridica", "filial");
		Empresa e3 = new Empresa(null, "12222222222", "Empresa11", "TstEmpresa11", "endereco", "cep", "cidade",
				"estado", "pais", 3, "cadastro", "tipoEmpresa");
		...
		Profissional pr1 = new Profissional(null, "Teste1", "teste1@mail.com", "123456", "11111111111", "cardiologista",
				"crm", "123456", "caminho do arquivo", "profissional", true);
		Profissional pr2 = new Profissional(null, "Teste2", "teste2@mail.com", "123456", "222222222", "fisioterapeuta",
				"crm", "123456", "caminho do arquivo", "profissional", true);
